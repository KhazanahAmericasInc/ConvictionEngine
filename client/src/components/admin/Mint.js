    ...
    return (
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="form-group">
            ...
            <input type="text" onChange={this.handleKAIAmount}  className="form-control" id="intputMintLevel" placeholder="Enter amount of KAI to mint"/>
          </div>
          <button type="submit" className="btn btn-primary">Mint KAI</button>
        </form>
        </React.Fragment>
    )
  }
