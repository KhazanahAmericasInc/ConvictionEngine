...
export default class CompanyPanel extends Component {
  // CompanyPanel is the panel component for each company. This includes the calls to action for each company.
  ...
  render() {
    // mapping if investment stage numbers to english
          ...
          <li className="list-group-item">
            ...
            <p>
              ...
              <span className="badge badge-success">
                +{company.total_conviction}
              </span>{" "}
              &nbsp;
              <span className="badge badge-danger">
                -{company.total_nconviction}
              </span>
            </p>
          </li>
          {company.on_project ? (
              ...
              <li className="list-group-item">
                <p className="card-text">
                  ...
                  <span className="badge badge-primary">
                    {company.on_hold
                      ? investmentStates[company.hold_state]
                      : investmentStates[company.investment_stage]}
                  </span>
                </p>
                <p className="card-text">
                  Your KAI Invested: &nbsp;
                  ...
                  {!company.on_hold ? null : (
                    <React.Fragment>(ON HOLD)</React.Fragment>
                  )}
                </p>
              </li>
              {!company.on_hold ? (
                <React.Fragment>
                  <li className="list-group-item">
                    ...
                    <div className="form-group">
                      ...
                      <button
                        className="btn btn-primary"
                        onClick={onHold.bind(this, company.company_id)}
                      >
                        Hold Project
                      </button>
                    </div>
                    ...
                    {company.on_team ? (
                      <React.Fragment>
                        ...
                        <div className="form-inline">
                          <input
                            className="form-control"
                            value={this.state.add_member}
                            onChange={this.handleAddMember}
                          />
                          <br />
                          <button
                            className="btn btn-primary"
                            onClick={onAddTeam.bind(
                              this,
