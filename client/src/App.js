...
class App extends Component {
  state = { storageValue: 0, web3: null, accounts: null, contract: null, tokens: 0 };
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState({ web3, accounts, contract: CEInstance }, this.runExample);
    } catch (error) {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>{this.state.tokens} Tokens</h1>
        <h1>Good to Go!</h1>
